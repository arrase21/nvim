...
--   end
--
--   -- Custom source for Codeium
--   local codeium_source = {
--     name = 'codeium',
--     get_completions = function()
--       local completions = vim.fn['codeium#Complete']()
--       -- Adapt Codeium completions to mini.completion format
--       local items = {}
--       if type(completions) == 'table' then
--         for _, completion in ipairs(completions) do
--           table.insert(items, {
--             word = completion.text or completion, -- Adjust based on Codeium's output
--             kind = 'Codeium',
--             menu = '[Codeium]',
--             info = completion.info or '',
--           })
...
--     sources = { codeium_source },
--     mappings = {
--       force_twostage = '<C-x><C-o>', -- Trigger LSP and custom sources (including Codeium)
--       force_oneshot = '<C-x><C-c>',  -- Trigger Codeium inline (ghost text)
--     },
--   })
--
...
--   end
--
--   -- Keymaps for Codeium (for ghost text)
--   vim.keymap.set('i', '<C-g>', function() return vim.fn['codeium#Accept']() end, { expr = true, silent = true })
--   vim.keymap.set('i', '<C-x>', function() return vim.fn['codeium#Clear']() end, { expr = true, silent = true })
--   vim.keymap.set('i', '<C-[>', function() return vim.fn['codeium#CycleCompletions'](1) end, { expr = true, silent = true })
--   vim.keymap.set('i', '<C-]>', function() return vim.fn['codeium#CycleCompletions'](-1) end, { expr = true, silent = true })
...
--     },
--     mappings = {
--       force_twostage = '<C-x><C-o>', -- Trigger LSP completions
--       force_oneshot = '<C-x><C-c>',  -- Trigger Codeium completions
--     },
--   })
--   -- Attach omnifunc for LSP only
